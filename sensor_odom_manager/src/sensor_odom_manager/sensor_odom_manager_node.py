...
class SensorOdomManager(object):  
    ...
    def __init__(self):
        ...
        self.odom_calc_hz    = get_param('~odom_calc_hz', 200)
        ...
        # ros publishers
        self.odom_publisher  = rospy.Publisher(self.odom_out_topic, Odometry, tcp_nodelay=True, queue_size=30)
    ...
    def main_loop(self):
        ...
        self.main_rate = rospy.Rate(200) # hz
